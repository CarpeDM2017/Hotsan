...
with open("C:\Users\User\Desktop\CarpeDM2017\Hotsan\database\workers\dedupe_yesterday.sql", 'r') as file:
    tools.table_from_query(file.read(), date_str=yesterday)

# Run today's Query
with open("C:\Users\User\Desktop\CarpeDM2017\Hotsan\database\workers\dedupe.sql", 'r') as file:
